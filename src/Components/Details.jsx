                ...
                {viewrepoData.map((repou) => {
                    return <div className='usercardbottomdetail'>
                        <div className='leftcardbottmdetail'>
                            <h3>{repou.name}</h3>
                            {console.log(viewrepoData)}
                        </div>
                        <div className='rightcardbottomdetail'>
                        <Link to={repou.clone_url} target="_blank"><button>View Repo</button> </Link>
                        <Link to={repou.homepage} target="_blank"><button>Live Demo</button></Link>
                        </div>
                    </div>
                    })}
              </ul>
